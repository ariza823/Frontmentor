...
export default () => { 
    const {cartProducts} = useContext(useCart);
    return (
...
<button className="w-full rounded-md bg-orange-primary py-4 text-white transition-all hover:bg-orange-600 ">Checkout</button>
</div>        
</div>
